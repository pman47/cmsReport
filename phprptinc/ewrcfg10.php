...
define("EWR_PROJECT_ID", "{83978599-D105-4032-957D-7610D67E8774}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "cmsReport", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "cms2", "qs" => "`", "qe" => "`");
...
// General
$EWR_ROOT_RELATIVE_PATH = "..\..\..\Users\KRISHNA\Documents\PHPReportMaker\WebSites\project1"; // Relative path of app root
define("EWR_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EWR_RANDOM_KEY", 'xXvv4A0ygzX07Zqe', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/cmsReport.css", TRUE); // Project stylesheet file name
