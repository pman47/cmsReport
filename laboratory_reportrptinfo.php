...
$laboratory_report = NULL;

//
// Table class for laboratory report
//
class crlaboratory_report extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'laboratory_report';
		$this->TableName = 'laboratory report';
		$this->TableType = 'VIEW';
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// lab_username
		$this->lab_username = new crField('laboratory_report', 'laboratory report', 'x_lab_username', 'lab_username', '`lab_username`', 200, EWR_DATATYPE_STRING, -1);
		...
		// lab_name
		$this->lab_name = new crField('laboratory_report', 'laboratory report', 'x_lab_name', 'lab_name', '`lab_name`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// lab_address
		$this->lab_address = new crField('laboratory_report', 'laboratory report', 'x_lab_address', 'lab_address', '`lab_address`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// contact_no
		$this->contact_no = new crField('laboratory_report', 'laboratory report', 'x_contact_no', 'contact_no', '`contact_no`', 20, EWR_DATATYPE_NUMBER, -1);
		...
		// lab_status
		$this->lab_status = new crField('laboratory_report', 'laboratory report', 'x_lab_status', 'lab_status', '`lab_status`', 200, EWR_DATATYPE_STRING, -1);
		...
		$this->lab_accepting_status = new crField('laboratory_report', 'laboratory report', 'x_lab_accepting_status', 'lab_accepting_status', '`lab_accepting_status`', 200, EWR_DATATYPE_STRING, -1);
		...
		// area_name
		$this->area_name = new crField('laboratory_report', 'laboratory report', 'x_area_name', 'area_name', '`area_name`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// pincode
		$this->pincode = new crField('laboratory_report', 'laboratory report', 'x_pincode', 'pincode', '`pincode`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// district_id
		$this->district_id = new crField('laboratory_report', 'laboratory report', 'x_district_id', 'district_id', '`district_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// district_name
		$this->district_name = new crField('laboratory_report', 'laboratory report', 'x_district_name', 'district_name', '`district_name`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// state_id
		$this->state_id = new crField('laboratory_report', 'laboratory report', 'x_state_id', 'state_id', '`state_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// state_name
		$this->state_name = new crField('laboratory_report', 'laboratory report', 'x_state_name', 'state_name', '`state_name`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// lab_id
		$this->lab_id = new crField('laboratory_report', 'laboratory report', 'x_lab_id', 'lab_id', '`lab_id`', 3, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`laboratory report`";
	}
	...
	function SetupLookupFilters($fld) {
		...
		case "x_area_name":
			$sSqlWrk = "";
		$sSqlWrk = "SELECT DISTINCT `area_name`, `area_name` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `laboratory report`";
		$sWhereWrk = "";
